...
[http://sourceforge.net/projects/winavr WinAvr] contains an executable
...
[http://tomeko.net/other/avrdude/building_avrdude.php here].
...
[http://www.mingw.org/wiki/MSYS MSYS] system from MinGW. Open an MSYS
